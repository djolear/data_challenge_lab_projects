...
**q2** Using `df`, plot `price` vs. `carat`. Since `df` consists of 53405 rows, using `geom_point()` would result in extreme overplotting. Instead, select a better geom. What conclusions can you draw?
